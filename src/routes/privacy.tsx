...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({ meta: [{ title: "سياسة الخصوصية — Right" }] }),
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <h1 className="mt-6 text-2xl font-black text-foreground">سياسة الخصوصية</h1>
        <p className="mt-4 text-sm leading-relaxed text-text-secondary">
          النص الكامل لسياسة الخصوصية قيد الإعداد والمراجعة القانونية حالياً، ولم يُعتمد بعد. إذا
          كان لديك استفسار بخصوص كيفية التعامل مع بياناتك قبل اعتماد السياسة رسمياً، يسعدنا تواصلك
          معنا مباشرة.
        </p>
        <a
