  ...
  return (
    <footer className="border-t border-border bg-bg-secondary">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
        <div>
          <div className="font-mono text-lg font-bold text-gold">RAYET · رايت</div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li>عن رايت</li><li>الشركاء</li><li>تواصل</li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 text-xs text-text-tertiary">
          <span>© 2025 رايت. جميع الحقوق محفوظة.</span>
          <span className="font-mono">SAMA Licensed · Riyadh</span>
        </div>
      </div>
    </footer>
  );
